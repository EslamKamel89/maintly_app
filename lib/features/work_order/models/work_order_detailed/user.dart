class User {
	...
	@override
	String toString() {
		return 'User(id: $id, organizationId: $organizationId, role: $role, name: $name, email: $email, emailVerifiedAt: $emailVerifiedAt, twoFactorConfirmedAt: $twoFactorConfirmedAt, createdAt: $createdAt, updatedAt: $updatedAt)';
	}
