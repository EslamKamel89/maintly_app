  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: SingleChildScrollView(
        ...
        child: _ScheduleCard(workOrder: workOrder)
            .animate()
...
class _ScheduleCard extends StatelessWidget {
  const _ScheduleCard({required this.workOrder});
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Icon(Icons.calendar_month_outlined, color: _kOrange, size: 22),
                ),
              ],
            ),
          ),
