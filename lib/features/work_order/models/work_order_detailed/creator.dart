class Creator {
	...
	@override
	String toString() {
		return 'Creator(id: $id, organizationId: $organizationId, role: $role, name: $name, email: $email, emailVerifiedAt: $emailVerifiedAt, twoFactorConfirmedAt: $twoFactorConfirmedAt, createdAt: $createdAt, updatedAt: $updatedAt)';
	}
