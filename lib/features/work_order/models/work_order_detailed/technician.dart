class Technician {
	...
	@override
	String toString() {
		return 'Technician(id: $id, organizationId: $organizationId, role: $role, name: $name, email: $email, emailVerifiedAt: $emailVerifiedAt, twoFactorConfirmedAt: $twoFactorConfirmedAt, createdAt: $createdAt, updatedAt: $updatedAt)';
	}
